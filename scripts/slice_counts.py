# this script finds count indices 
...
if __name__ == "__main__":
    ...
    if args.data == "sm2":
        ...
        wpath = "/bigstore/GeneralStorage/jperrie/probe_design/data/slice/sm2/"
    elif args.data == "tenx":
        dpath =  "/bigstore/binfo/mouse/Brain/Sequencing/Allen_10X_2020/"
        metadata_fpath = os.path.join(dpath, "metadata.csv")
        counts_fpath = os.path.join(dpath, "counts.npy")
        wpath = "/bigstore/GeneralStorage/jperrie/probe_design/data/slice/tenx/"
